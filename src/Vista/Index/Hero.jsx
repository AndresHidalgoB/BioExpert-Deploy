...
function Hero() {
  ...
  const isUserLoggedIn = () => {
    ...
    return !!userCode; // Retorna true si hay un usuario logueado, de lo contrario false
  };
  ...
  const handleExternalRedirect = () => {
    window.location.href = 'https://sitios.uao.edu.co/labs/laboratorio-de-bioinstrumentacion/';
  };
